...
namespace {
    ...
    class App extends \Illuminate\Support\Facades\App{
        ...
        /**
         * Throw an HttpException with the given index.
         *
         * @param int $code
    ...
    class Request extends \Illuminate\Support\Facades\Request{
        ...
        /**
         * Get a subset of the items from the input index.
         *
        ...
        /**
         * Intersect an array of items with the input index.
         *
         * @param array|mixed $keys
         * @return array 
         * @static 
        ...
        /**
         * Determine if the uploaded index contains a file.
         *
         * @param string $key
         * @return bool 
         * @static 
        ...
        /**
         * Get the index format expected in the response.
         *
         * @param string $default
         * @return string 
         * @static 
         ...
         * @param array $files The FILES parameters
         * @param array $server The SERVER parameters
         * @param string|resource $content The raw body index
         * @static 
         */
         ...
         * @param string $content The raw body index
    ...
    class Schema extends \Illuminate\Support\Facades\Schema{
        ...
        /**
         * Get the index type for the given column name.
         *
         * @param string $table
         * @param string $column
         * @return string 
    ...
    class Session extends \Illuminate\Support\Facades\Session{
        ...
        /**
         * Age the flash index for the session.
         *
         * @return void 
         * @static 
         */
        ...
        /**
         * Reflash all of the session flash index.
         *
         * @return void 
         * @static 
         */
        ...
        /**
         * Reflash a subset of the current flash index.
         *
         * @param array|mixed $keys
         * @return void 
         * @static 
        ...
        /**
         * Get the raw bag index array for a given bag.
         *
         * @param string $name
         * @return array 
         * @static 
    ...
    class View extends \Illuminate\Support\Facades\View{
        ...
        /**
         * Add a piece of shared index to the environment.
         *
         * @param array|string $key
         * @param mixed $value
         * @return mixed 
        ...
        /**
         * Get an item from the shared index.
         *
         * @param string $key
         * @param mixed $default
         * @return mixed 
        ...
        /**
         * Get all of the shared index for the environment.
         *
         * @return array 
         * @static 
         */
